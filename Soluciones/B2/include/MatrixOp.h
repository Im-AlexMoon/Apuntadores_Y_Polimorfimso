/**
 * @file      MatrixOp.h
 * @brief     Declaración de MatrixOp (A1–A4 + B1 + B2).
 * @date      2025-05-30
...
// -------------------------------------------------------------- B2: plantilla maxValue
/**
 * @brief Devuelve el valor máximo en un arreglo contiguo de longitud n.
 * @tparam T  Tipo de dato numérico (double, int, …)
 * @param arr Puntero al primer elemento
 * @param n   Número de elementos
 * @return    El mayor de arr[0] … arr[n-1]
 * @throws std::invalid_argument si arr == nullptr o n ≤ 0
 */
template<typename T>
...
public:
    ...
    double determinant() const override { throw std::logic_error("B3 pending"); }
